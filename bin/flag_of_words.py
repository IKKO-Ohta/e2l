...
def calc_f(gold_labels_list, output_labels_list):
    ...
    ??? Is there functions pre-installed.?
    '''
...
#    train_N_matrix = to_categorical(train_N_list, 101)  # sparse
    print(type(train_factors_list))
    print(train_factors_list)
    train_factors_matrix = to_categorical_multi(train_factors_list, 101)
    print(train_factors_matrix)
    print(train_factors_matrix.shape)
